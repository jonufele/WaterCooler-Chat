...
class WcChat {
    ...
    private function ajax($mode) {
        ...
        switch($mode) {
            ...
            break;
            // Create a new chat start point (After a Screen Cleanup)
            ...
            break;
            // Retrieves Password Form If Required
            case 'get_pass_input':
                echo $this->popTemplate(
                    'wcchat.join.password_required',
                    array(
